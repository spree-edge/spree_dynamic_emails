module Spree
  class ShipmentMailer < BaseMailer
    ...
    def shipment_details
      ...
      line_item_details = render_to_string(partial: 'spree/shared/purchased_items_table', locals: {line_items:  @shipment.manifest.map(&:line_item), order: @shipment.order })
      line_items_table = render_to_string(collection: @shipment.order.line_items, partial: 'spree/shared/purchased_items_table/line_item', as: :line_item)
